...
namespace Aspose.ThreeD.Animation
{
    public class KeyframeSequence
    {
        ...
        public Aspose.ThreeD.Vector4 Interpolate(float time)
        {
            if (_keyFrames.Count == 0)
            {
                return new Aspose.ThreeD.Vector4(0, 0, 0, 0);
            }
            ...
            switch (prevFrame.Interpolation)
            {
                ...
                case Interpolation.LINEAR:
                    ...
                    var diffZ = v1.Z - v0.Z;
                    var diffW = v1.W - v0.W;
                    var result = new Aspose.ThreeD.Vector4(
                        v0.X + diffX * t,
                        v0.Y + diffY * t,
                        v0.Z + diffZ * t,
                        v0.W + diffW * t
        ...
        private Aspose.ThreeD.Vector4 InterpolateBezier(KeyFrame prevFrame, KeyFrame nextFrame, float t)
        {
            float t2 = t * t;
            float t3 = t2 * t;
            ...
            Aspose.ThreeD.Vector4 p0 = prevFrame.Value;
            Aspose.ThreeD.Vector4 p3 = nextFrame.Value;

            float duration = nextFrame.Time - prevFrame.Time;
            Aspose.ThreeD.Vector4 m0 = new Aspose.ThreeD.Vector4(
                prevFrame.TangentOut.X * duration,
                prevFrame.TangentOut.Y * duration,
                prevFrame.TangentOut.Z * duration,
                0
            );
            Aspose.ThreeD.Vector4 m1 = new Aspose.ThreeD.Vector4(
            ...
            Aspose.ThreeD.Vector4 result = p0 * h1 + m0 * h3 + p3 * h2 + m1 * h4;
            return result;
        }
    }
}
